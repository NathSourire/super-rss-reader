<main>
    ...
    <div class="container-fluid">
        ...
        ?>
                    ...
                    <h4 class="text-center my-3"><a class="link-offset-2 link-underline link-underline-opacity-0 text-white" href="/controllers/pages-controller.php?subject=<?= $url ?>"><?= $name ?></a></h4>
            ...
            ?>
                    <a class="link-offset-2 link-underline link-underline-opacity-0 link" target="_blank" href="<?= $link ?>">
